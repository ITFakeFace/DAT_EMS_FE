...
const instantExtremaLabels = {
  ...
  afterDatasetsDraw(chart, _args, options) {
    ...
    indexes.forEach((index) => {
      ...
      ctx.fillStyle = options.color || "rgb(34, 211, 238)";
      ctx.shadowColor = options.color || "rgb(34, 211, 238)";
      ctx.shadowBlur = 8;
      ctx.fill();
      ctx.shadowBlur = 0;
      ctx.beginPath();
...
export default function WaterDetail() {
  ...
  const currentTrend = trendConfig.water;
  ...
  return (
    <div className="DAT_WaterDetail">
      ...
      {/* =========================
          TREND CHART - CHỈ WATER
      ========================= */}

      <div className="DAT_WaterDetail_TrendCard">
        <div className="DAT_WaterDetail_TrendCard_Charts">
          {/* Instant Chart */}
          <div className="DAT_WaterDetail_TrendCard_Charts_Instant">
            <div className="DAT_WaterDetail_TrendCard_Charts_Instant_Header">
              <div className="DAT_WaterDetail_TrendCard_Charts_Instant_Header_Label">
                <span className="DAT_WaterDetail_TrendCard_Charts_Instant_Header_Title">
                  {lang.formatMessage({ id: "dashboard_trend_instant" })}
                </span>
                <span className="DAT_WaterDetail_TrendCard_Charts_Instant_Header_Unit">
                  ({currentTrend.instantUnit})
                </span>
              </div>

              <input
                className="DAT_WaterDetail_TrendCard_Charts_Instant_Header_Date"
                type="date"
                value={instantDate}
                max={getToday()}
              ...
              <button
                className="DAT_WaterDetail_TrendCard_Charts_Instant_Header_Export"
                type="button"
              >
                <FaDownload />
                Export
            ...
            <div className="DAT_WaterDetail_TrendCard_Charts_Instant_Content">
              <Line
                ref={instantChartRef}
          ...
          <div className="DAT_WaterDetail_TrendCard_Charts_Line" />

          {/* Accumulated Chart */}
          <div className="DAT_WaterDetail_TrendCard_Charts_Accumulated">
            {/* HEADER */}
            <div className="DAT_WaterDetail_TrendCard_Charts_Accumulated_Header">
              <div className="DAT_WaterDetail_TrendCard_Charts_Accumulated_Header_Title">
                <span>
                  {lang.formatMessage({
                    id: "dashboard_trend_accumulated",
                  })}
                </span>
                <span className="DAT_WaterDetail_TrendCard_Charts_Accumulated_Header_Title_Unit">
                  ({currentTrend.accumulatedUnit})
                </span>
              </div>

              <div className="DAT_WaterDetail_TrendCard_Charts_Accumulated_Header_Actions">
                {compareText && (
                  <span
                    className="DAT_WaterDetail_TrendCard_Charts_Accumulated_Header_Compare"
                    style={{
                      color: compareColor,
                    }}
                  >
                ...
                <div className="DAT_WaterDetail_TrendCard_Charts_Accumulated_Header_Period">
                  <button
                    type="button"
                    className={`DAT_WaterDetail_TrendCard_Charts_Accumulated_Header_Period_Item ${
                      accumulatedPeriod === "week"
                        ? "DAT_WaterDetail_TrendCard_Charts_Accumulated_Header_Period_Item_Active"
                        : ""
                    }`}
            ...
            {/* CHART */}
            <div className="DAT_WaterDetail_TrendCard_Charts_Accumulated_Content">
              <Bar
