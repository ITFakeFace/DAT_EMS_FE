...
function TreeNode({ node, isRoot = false, onOpenModal, navigate, lang }) {
  ...
  return (
    ...
    >
      <div className={isRoot ? "DAT_Water_Branch_ZoneRoot" : ""}>
      ...
      {hasChildren && isExpanded && (
        <>
          ...
          <div className="DAT_Water_Branch_ChildrenWrap">
            <div className="DAT_Water_Branch_ChildrenWrap_ZoneChildren">
              <div className="DAT_Water_Branch_ChildrenWrap_ZoneChildren_Grid">
                {node.children.map((child, idx) => {
                  ...
                  return (
                    <div
                      key={child.id || idx}
                      className={`DAT_Water_Branch_ChildrenWrap_ZoneChildren_Grid_Col DAT_Water_Branch_ChildrenWrap_ZoneChildren_Grid_Col--${side}`}
                    >
                      <div className="DAT_Water_Branch_ChildrenWrap_ZoneChildren_Grid_Col_LineUp" />
                      <TreeNode
                        node={child}
  ...
  return (
    <div className="DAT_Water">
      ...
      <div className="DAT_Water_TopBar">
        <button
          type="button"
          className={`DAT_Water_TopBar_RoiBtn ${isDrawingMode ? "active" : ""}`}
      ...
      <div className="DAT_Water_CanvasWrap">
        ...
        <div className="DAT_Water_CanvasWrap_ScrollContainer">
          <div
            ref={boardRef}
            className="DAT_Water_CanvasWrap_ScrollContainer_MainBoard"
          ...
          >
            {rois
              ...
              .map((roi) => {
                ...
                return (
                  ...
                  >
                    <div
                      className="DAT_Water_RoiBox_Badge"
                      style={{
                        pointerEvents: "auto",
                      }}
                    >
            ...
            {currentBox && isDrawing && (
              <div
                className="DAT_Water_RoiDrawingBox"
                style={{
