const enMessages = {
  ...
  sidebar_settings_emission_electricity: "Emission & Electricity Settings",
  sidebar_settings_alarm_threshold: "Alarm Threshold Settings",
  alarm_setting_title: "Alarm Threshold Settings",
  alarm_setting_back: "Back to Dashboard",
  alarm_setting_system_electricity: "ELECTRICITY SYSTEM",
  alarm_setting_system_water: "WATER SYSTEM",
  alarm_setting_system_air: "GAS SYSTEM",
  alarm_setting_area: "Area",
  alarm_setting_area_motor: "DEMO MOTOR PMSM",
  alarm_setting_area_solar: "DEMO SOLAR",
  alarm_setting_area_bess: "DEMO BESS",
  alarm_setting_area_four_pumps: "DEMO 4 BƠM",
  alarm_setting_area_two_pumps: "DEMO 2 BƠM",
  alarm_setting_area_greenhouse: "TRẠM KHÍ NHÀ KÍNH",
  alarm_setting_area_workshop: "TRẠM KHÍ PHÂN XƯỞNG",
  alarm_setting_thresholds: "Alarm Thresholds",
  alarm_setting_for_station: "for station",
  alarm_setting_on_off: "ON / OFF",
  alarm_setting_metric_name: "METRIC NAME",
  alarm_setting_unit: "UNIT",
  alarm_setting_updated_time: "UPDATED TIME",
  alarm_setting_threshold: "THRESHOLD",
  alarm_setting_action: "ACTION",
  alarm_setting_metric_power: "Công suất",
  alarm_setting_metric_current: "Dòng điện",
  alarm_setting_metric_voltage: "Điện áp",
  alarm_setting_metric_motor_speed: "Tốc độ motor",
  alarm_setting_metric_motor_temperature: "Nhiệt độ motor",
  alarm_setting_metric_max_pipe_pressure: "Áp suất đường ống tối đa",
  alarm_setting_metric_min_pipe_pressure: "Áp suất đường ống tối thiểu",
  alarm_setting_metric_max_air_pressure: "Áp suất khí nén tối đa",
  alarm_setting_metric_min_air_pressure: "Áp suất khí nén tối thiểu",
  alarm_setting_metric_accumulated_flow: "Lưu lượng tích lũy",
  alarm_setting_turn_on: "Turn on",
  alarm_setting_turn_off: "Turn off",
  alarm_setting_edit: "Edit",
  alarm_setting_save: "Save Settings",
  ...
  sidebar_item_alarm_management2: "Reports",
  add_alarm: "Add alarm",
  ...
  electric_detail_year: "This year",
  electric_detail_yesterday: "Yesterday",
  electric_detail_previous_month: "Previous month",
  electric_detail_previous_year: "Previous year",
...
const viMessages = {
  ...
  sidebar_item_alarm_management2: "Báo cáo",
  sidebar_item_user_management: "Quản lý người dùng",
  sidebar_item_system_settings: "Cài đặt hệ thống",
  sidebar_settings_emission_electricity:
    "Cài đặt chỉ số phát thải & Tiền điện",
  sidebar_settings_alarm_threshold: "Cài đặt ngưỡng cảnh báo",
  alarm_setting_title: "Cài đặt ngưỡng cảnh báo",
  alarm_setting_back: "Quay lại Dashboard",
  alarm_setting_system_electricity: "HỆ THỐNG ĐIỆN",
  alarm_setting_system_water: "HỆ THỐNG NƯỚC",
  alarm_setting_system_air: "HỆ THỐNG KHÍ NÉN",
  alarm_setting_area: "Khu vực",
  alarm_setting_area_motor: "DEMO MOTOR PMSM",
  alarm_setting_area_solar: "DEMO SOLAR",
  alarm_setting_area_bess: "DEMO BESS",
  alarm_setting_area_four_pumps: "DEMO 4 BƠM",
  ...
  alarm_setting_area_greenhouse: "TRẠM KHÍ NHÀ KÍNH",
  alarm_setting_area_workshop: "TRẠM KHÍ PHÂN XƯỞNG",
  alarm_setting_thresholds: "Ngưỡng cảnh báo",
  alarm_setting_for_station: "của trạm",
  alarm_setting_on_off: "BẬT / TẮT",
  alarm_setting_metric_name: "TÊN CHỈ SỐ",
  alarm_setting_unit: "ĐƠN VỊ",
  alarm_setting_updated_time: "THỜI GIAN CẬP NHẬT",
  alarm_setting_threshold: "NGƯỠNG CẢNH BÁO",
  alarm_setting_action: "THAO TÁC",
  alarm_setting_metric_power: "Công suất",
  alarm_setting_metric_current: "Dòng điện",
  alarm_setting_metric_voltage: "Điện áp",
  alarm_setting_metric_motor_speed: "Tốc độ motor",
  ...
  alarm_setting_metric_min_air_pressure: "Áp suất khí nén tối thiểu",
  alarm_setting_metric_accumulated_flow: "Lưu lượng tích lũy",
  alarm_setting_turn_on: "Bật",
  alarm_setting_turn_off: "Tắt",
  alarm_setting_edit: "Sửa",
  alarm_setting_save: "Lưu thông số cài đặt",
  ...
  electric_detail_year: "Năm nay",
  electric_detail_yesterday: "Hôm qua",
  electric_detail_previous_month: "Tháng trước",
  electric_detail_previous_year: "Năm trước",
  ...
  system_setting_electricity_price_tier_save_success:
    "Đã lưu thông số cài đặt hệ thống thành công! Dữ liệu tính toán phát thải & chi phí đã tự động cập nhật.",
